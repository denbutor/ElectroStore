...
# async def delete_product_by_name(name: str, db: AsyncSession = Depends(AsyncSessionLocal)):
#     # Знаходимо продукт по імені
...
#     await db.commit()
#
#     return {"detail": f"Product '{name}' deleted successfully"}
#-----------------------------------------------------------------------
